...
async def update_role_labels(ctx: Ctx, role_labels: list[dict]) -> None:
    """Só org_admin — é configuração da organização inteira, não de um
    membro. Cada entrada é {"label": ..., "roles": [...]}: um rótulo pode
    agrupar vários papéis técnicos, e o mesmo papel pode aparecer em mais
    de uma entrada. Os papéis em si (VALID_ROLES) já foram validados no
    schema; aqui só falta persistir."""
