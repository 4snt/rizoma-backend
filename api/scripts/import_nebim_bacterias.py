...
def main() -> None:
    ...
    created_samples, created_tests, warnings = 0, 0, []
        ...
        with open(args.csv_path, newline="", encoding="utf-8") as f:
            for row in csv.DictReader(f):
                ...
                body = {
                    ...
                    "treatment_group": (row.get("Bac") or "").strip() or None,
                }
                r = client.post(
    ...
    print(f"{created_samples} amostra(s) criada(s), {created_tests} teste(s) criado(s).")
    if warnings:
